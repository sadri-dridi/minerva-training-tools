<template>
  <div class="row q-col-gutter-sm  q-py-sm">
    ...
    <!-- <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
      <q-card class="q-ma-xs" style="background-color: #ea4b64; border-radius: 15px; overflow: hidden">
        <q-card-section class="text-h6 text-white">
          Daily Sales
        </q-card-section>
        <q-card-section class="q-pa-none">
  ...
  setup () {
    ...
    LineChart2: {
      ...
      GuageChart: {
        ...
        "series": [{"name": 'Pressure',"type": "gauge", "progress": {"show": true}, "detail": {"valueAnimation": true, "formatter": '{value}'}, "data": [{"value": 50, "name": 'score'}]}],
        "color": ["#005ea8"]
      },
      line_chart: null,
      line_chart_2: null,
